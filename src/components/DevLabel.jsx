...
const SCREENS = [
  ...
  { pattern: /^\/app\/admin\/train-estimator$/, label: 'Admin · Train Estimator (redirect)' },
  { pattern: /^\/app\/learning\/train-estimator$/, label: 'Learning Center · Train Estimator' },
  { pattern: /^\/app\/learning\/calendars-weekly-efficiency$/, label: 'Learning Center · Calendars' },
